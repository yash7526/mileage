document.addEventListener("DOMContentLoaded", () => {
    ...
    let baseMileage = 121;      // Maximum mileage (default with only the driver)
    ...
    function updateMileage() {
        ...
        if (isPassengerAreaEmpty) {
            ...
            const reductionPerPassenger = (baseMileage - 90) / 6; // Reduction between max and min mileage over 4 passengers

            // Calculate adjusted mileage
            const adjustedMileage = Math.max(baseMileage - reductionPerPassenger * (passengerCount - 1), 90);
